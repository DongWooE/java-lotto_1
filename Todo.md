...
## Todo
- [ ] 보너스 당첨 여부에 따른 금액 계산((4개 일치, 당첨) -> 50000, (5개 일치, 당첨) -> 30000000, (5개 일치, 미당첨) -> 1500000, (6개 일치, 당첨) -> 2000000000)
- [ ] 보너스 번호 문구 출력(보너스 볼을 입력해 주세요.)
- [ ] 보너스 번호 입력
- [ ] 당첨 통계 문구 추가("5개 일치, 보너스 볼 일치(30000000원) - 0개")
